...
export type SidebarView = 'kanban' | 'terminals' | 'roadmap' | 'context' | 'ideation' | 'github-issues' | 'gitlab-issues' | 'github-prs' | 'gitlab-merge-requests' | 'changelog' | 'chat' | 'worktrees' | 'agent-tools';
...
const baseNavItems: NavItem[] = [
  ...
  { id: 'chat', labelKey: 'navigation:items.chat', icon: MessagesSquare, shortcut: 'N' },
